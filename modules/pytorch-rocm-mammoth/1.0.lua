...
setenv('SINGULARITYENV_LD_LIBRARY_PATH', '/usr/local/lib:/opt/rocm/lib/:/usr/local/lib/python3.11/dist-packages/faiss:/opt/cray/libfabric/1.15.2.0/lib64')
setenv('SING_FLAGS', '-B /opt/cray')  -- -B /opt/rocm/lib/librccl.so:/usr/local/lib/python3.10/dist-packages/torch/lib/librccl.so')
